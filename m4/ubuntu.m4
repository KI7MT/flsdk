	...
	ubuntu|kubuntu|xubuntu|lubuntu )
		...
		case "${distrov}" in
			14.04*|14.10* )
				...
				#        using both Pulseaudio, ALSA, pavcontrol
				BASE_LIST='asciidoc automake devscripts dialog docbook-xsl 
doxygen-latex extra-xdg-menus fluid gawk gettext git imagemagick \
libasound2-dev libcairo2-dev libfltk1.3-dev libgl1-mesa-dev libglu1-mesa-dev \
libhamlib-dev libhamlib-utils libjpeg8-dev libpng12-dev libpulse-dev \
librpc-xml-perl libsamplerate0-dev libsndfile1-dev libterm-readline-gnu-perl \
libtool libusb-dev libwww-perl libx11-dev libxext-dev libxft-dev libxinerama-dev \
libxmlrpc-core-c3-dev lsb-release pavucontrol pkg-config portaudio19-dev \
subversion texinfo texlive-font-utils xsltproc zlib1g-dev'
